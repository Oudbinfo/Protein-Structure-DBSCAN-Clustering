...
class Foldseek:
    ...
    def easy_search(self, input_file, db, output_file, temp_dir, columns, eval="1.000E+01", exhaustive="0",
        ...
        # Define arguments
        exe_args = [self.exe_path, "easy-search", input_file, db, output_file, temp_dir, "--format-output", columns,
                    "-e", eval, "--exhaustive-search", exhaustive]
        # Run process
    ...
    def search(self, query_db, target_db, alignment_db, temp_dir, exhaustive="1", align_type="1", e="inf",
               cwd_path='.'):
        ...
        exe_args = [self.exe_path, "search", query_db, target_db, alignment_db, temp_dir,
                    "--exhaustive-search", exhaustive, "--alignment-type", align_type, "-e", e]
        # Run process
